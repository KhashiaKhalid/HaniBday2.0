...
<div style="text-align:center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial;">
  ...
  <p style="color: #e91e63; margin-top:8px; font-size:20px; font-weight:bold;">
    Chapter 22 of rizzing up level 10 Gyatt
  </p>
  <p style="color: #e91e63; margin-top:8px; font-size:20px; font-weight:bold;">
    Jokes apart, may Allah grant you with everything that your heart desires and more. 
    May you be blessed with endless happiness and peace in this world and in the heareafter. 
    I hope you actually get to uncover some of the world's biggest mysteries.. whichever one you want.  
    And just know that I'll always be there for you (Better run for your life bro)
    With love, Your level 10 Gyatt lol 💖
  </p>
</div>
